...
// select rtc chip type: DS1307 or PCF8523
//#define DS1307  // old logging shield
#define PCF8523
...
#ifdef DS1307
#define VER_SHIELD 0xa
RTC_DS1307 RTC;
#endif

#ifdef PCF8523
#define VER_SHIELD 0xb
RTC_PCF8523 RTC;
#endif
...
void setup() {
  ...
  sprintf(date, "Version %x.%02x%x", VER_MAJ, VER_MIN, VER_SHIELD);
  lcd.setCursor(0,0);
  lcd.print(date);
  delay(1000);
